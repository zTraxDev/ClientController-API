...
const clientValidator = [
    ...
    check("date_pay").isDate().notEmpty().withMessage('La fecha de pago es requerida y debe ser una fecha válida'),
    check("last_pay").isDate().notEmpty().withMessage('La última fecha de pago es requerida y debe ser una fecha válida'),
    check("client_status")
        .optional()
